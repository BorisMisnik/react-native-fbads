...
import {findNodeHandle, requireNativeComponent, View, ViewPropTypes,Text, TouchableOpacity} from 'react-native';
...
class TriggerableViewChild extends React.Component<PropsType> {
  ...
  render() {
    if (this.props.touchable) {
        return <TouchableOpacity {...this.props} ref={this._handleWrapperRef} />;
    } else {
